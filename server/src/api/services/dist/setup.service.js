...
var SetupService = /** @class */ (function () {
    function SetupService(repository) {
        this.repository = repository;
    }
    SetupService.prototype.getSetupById = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            var setup;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getOneSetup(id)];
                    case 1:
                        setup = _a.sent();
                        if (!setup) {
    ...
    SetupService.prototype.getAllSetups = function (filter) {
        return __awaiter(this, void 0, Promise, function () {
            var setups;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getSetups(filter)];
                    case 1:
                        setups = _a.sent();
                        return [2 /*return*/, setups];
                }
            });
        });
    };
    SetupService.prototype.createSetup = function (inputSetup, setupMiddleware) {
        return __awaiter(this, void 0, Promise, function () {
            var setup;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, setupMiddleware(inputSetup)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.repository.createSetup(inputSetup)];
                    case 2:
                        setup = _a.sent();
                        return [2 /*return*/, setup];
                }
