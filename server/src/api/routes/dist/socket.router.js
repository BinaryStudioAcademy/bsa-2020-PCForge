...
function router(fastify, opts, next) {
    var _this = this;
    var SocketService = fastify.services.SocketService;
    var preHandler = userRequest_middlewarre_1.userRequestMiddleware(fastify);
    fastify.addHook('preHandler', preHandler);
    var getAllSchema = swagger_helper_1.getMultipleQuery(socket_schema_1.GetAllSockets, base_filter_1.IFilter.schema);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, SocketService.getAllSockets(request.query)];
                case 1:
                    sockets = _a.sent();
                    reply.send(sockets);
                    return [2 /*return*/];
    ...
    var getOneSchema = swagger_helper_1.getOneQuery(socket_schema_1.SocketSchema, undefined, false);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, SocketService.getSocketById(id)];
                case 1:
                    socket = _a.sent();
                    reply.send(socket);
                    return [2 /*return*/];
    ...
    var createOneSchema = swagger_helper_1.createOneQuery(socket_schema_1.CreateSocketSchema, socket_schema_1.SocketSchema);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, SocketService.createSocket(request.body)];
                case 1:
                    socket = _a.sent();
                    reply.send(socket);
                    return [2 /*return*/];
    ...
    var updateOneSchema = swagger_helper_1.updateOneQuery(socket_schema_1.UpdateSocketSchema, socket_schema_1.SocketSchema);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    allowFor_middleware_1.allowForAdmin(request);
                    id = request.params.id;
                    return [4 /*yield*/, SocketService.updateSocketById({ id: id, data: request.body })];
                case 1:
                    newSocket = _a.sent();
    ...
    var deleteOneSchema = swagger_helper_1.deleteOneQuery(socket_schema_1.SocketSchema);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    allowFor_middleware_1.allowForAdmin(request);
                    id = request.params.id;
                    return [4 /*yield*/, SocketService.deleteSocketById(id)];
                case 1:
                    socket = _a.sent();
                    reply.send(socket);
                    return [2 /*return*/];
