...
function (_super) {
  ...
  IRateFilter.schema = {
    ...
    properties: __assign(__assign({}, base_filter_1.IFilter.schema.properties), {
      ratebleType: (_ratebleType = {
        type: 'string',
        minLength: 1
      }, _defineProperty(_ratebleType, "minLength", 1), _defineProperty(_ratebleType, "enum", ['news', 'game', 'setup']), _defineProperty(_ratebleType, "nullable", true), _ratebleType),
      ratebleId: {
        type: 'integer',
        minimum: 1,
        nullable: true
